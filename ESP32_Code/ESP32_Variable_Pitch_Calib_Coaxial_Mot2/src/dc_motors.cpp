...
const int MAX_DUTY_CYCLE = (int)(pow(2, PWMResolution) - 1);
        ...
        // double kp1=15.0,ki1=0.0,kd1=0.0;
        ...
        double ku1 = 290.0; double tu1 = 0.3;
        // PID
        // double kp1=0.6*ku1,ki1=1.2*ku1/tu1,kd1=0.075*ku1*tu1;
        // PD
        //double kp1=0.8*ku1,ki1=0.0,kd1=0.1*ku1*tu1;
        
        //Post tuning correction
        double kp1=354.5,ki1=0.0,kd1=0.1*ku1*tu1;
        ...
        static portMUX_TYPE output2Mutex = portMUX_INITIALIZER_UNLOCKED;
        ...
        double ku2 = 290.0; double tu2 = 0.3;
        // PID
        // double kp1=0.6*ku1,ki1=1.2*ku1/tu1,kd1=0.075*ku1*tu1;
        // PD
        //double kp1=0.8*ku1,ki1=0.0,kd1=0.1*ku1*tu1;
        ...
        //Post tuning correction
        double kp2=354.5,ki2=0.0,kd2=0.1*ku2*tu2;
        ...
        const char ENC2_CHANA_PIN = 4;
        const char ENC2_CHANB_PIN = 16;
